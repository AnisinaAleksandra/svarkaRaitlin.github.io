...
>Адрес</Link>
        ...
        <div className={styles.contacts_block}>
            <div className={styles.number_phone}><img src={`${svg}`} alt="React Logo" />
                <a href="tel:+7(913)754-58-65">+7(913)754-58-65</a></div>
            <div className={styles.schedule}>Пн-Вс с 9:00 до 20:00</div>
        </div>

        <div className={styles.btn_call_container}>
        <Button rightIcon={<PhoneIcon />} colorScheme='yellow' onClick={() => {
